...
<head>
    ...
    <link href="{{ asset('frontapp') }}/lib/animate/animate.min.css" rel="stylesheet">
    <link href="{{ asset('frontapp') }}/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">


    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('frontapp') }}/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('frontapp') }}/css/style.css" rel="stylesheet">
</head>
            ...
            <div class="col-md-4 col-lg-3 text-center text-lg-start">
                <div class="d-inline-flex align-items-center">
                    <a href="" class="navbar-brand p-0">
                        ...
                        <!-- <img src="{{ 'frontapp' }}/img/logo.png" alt="Logo"> -->
                    </a>
                </div>
            </div>
