    ...
    <script src="{{ asset('frontapp') }}/lib/wow/wow.min.js"></script>
    <script src="{{ asset('frontapp') }}/lib/owlcarousel/owl.carousel.min.js"></script>


    <!-- Template Javascript -->
    <script src="{{ asset('frontapp') }}/js/main.js"></script>
</body>
